...
function determineAmount(input1, input2, input3, input4, input5, input6, input7, input8, input9, input10, input11, input12, input13, input14, input15, input16, input17, input18)
...
Account.prototype.pizzaOrder = function(prettyPizza) {
  if (valTotal <= )
}
